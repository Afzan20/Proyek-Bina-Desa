    ...
    <div class="col-md-6">
        <div class="card shadow p-4 bg-dark text-white">
            <div class="text-center mb-4">
                <h3 class="fw-bold text-white">Daftar Akun Bina Desa</h3>
                <p class="text-secondary">Silakan isi form di bawah ini</p>
            </div>
            ...
            <form method="POST" action="{{ route('login.register') }}">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <a href="{{ route('login.index') }}" class="text-primary small">Sudah punya akun?</a>
