...
@section('title', 'Dashboard | Proyek Bina Desa')
...
@section('content')
    <div class="container-fluid py-4">
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Mutasi</p>
                                        <h5 class="font-weight-bolder mb-0">
                                            {{ $totalMutasiAset }}
                                        </h5>
                                    </div>
        ...
        <!-- === KONTEN SELANJUTNYA (kategori, kondisi, mutasi, tabel aset, lokasi, pemeliharaan) === -->
        {{-- Potongan konten asli kamu tetap sama --}}
